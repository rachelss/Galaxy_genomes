...
Select your data from the Google Drive that your instructor shared with you.
...
3. Even if it fails click on the "eye" to view the summary analysis. You should see some information about your assembly, particularly how many of the expected genes were not found. If only a few are missing then you have a good assembly.
